                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <fl-project-form id="ad_post_form">
                            ...
                            <form class="fl-form" action="{LINK_POST-AD}?action=post_ad" id="post-advertise-form" method="post" enctype="multipart/form-data">
                                ...
                                <li>
                                    ...
                                    <fieldset class="PagePostProject-fieldset">
                                        ...
                                        <ol>
                                            <li class="form-step">
                                                <textarea class="large-textarea focusable-field" placeholder="{LANG_AD_DESCRIPTION}..." name="content" rows="5"></textarea>
                                ...
                                <li style="padding-bottom: 20px;">
                                    ...
                                    <div class="row form-group" id="st_prece-field">
