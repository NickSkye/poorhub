...
elseif($code_count == 2){
    $whr = "country_code = '".$country."' and subadmin1_code = '".$subadmin1."'";
}
elseif($code_count == 3){
    $whr = "country_code = '".$country."' and subadmin1_code = '".$subadmin1."' and subadmin2_code = '".$subadmin2."'";
}
...
while( $row = mysqli_fetch_array($queryRecords) ) {
    ...
    $subadmin1_code = $country_code.".".$row['subadmin1_code'];
    $subadmin2_code = $subadmin1_code.".".$row['subadmin2_code'];
