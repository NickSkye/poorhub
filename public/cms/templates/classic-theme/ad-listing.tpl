                            ...
                            <div class="featured-top" id="listing-filter">
                                <div class="tab-box ">
                                    ...
                                    <ul class="nav nav-tabs" id="quick-filter">
                                        ...
                                        <li role="presentation" IF("{FILTER}"=="featured"){ class="active" {:IF}><a href="#" data-filter-type="filter" data-filter-val="featured">{LANG_FEATURED}
                                        <span class="badge"> {FEATUREDFOUND} </span></a></li>
                                        <li role="presentation" IF("{FILTER}"=="urgent"){ class="active" {:IF}><a href="#" data-filter-type="filter" data-filter-val="urgent">{LANG_URGENT}
...
<script type="text/javascript">
    ...
    var loginurl = "{LINK_LOGIN}?ref=listing.php"</script>
